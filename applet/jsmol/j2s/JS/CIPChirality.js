...
if (!(this.root = cipAtom = Clazz.innerTypeInstance (JS.CIPChirality.CIPAtom, this, null).create (atom, null, false, false, false)).canBePseudo) {
return 0;
}this.haveIsotopes = false;
}if (cipAtom.setNode ()) {
...
case 6:
case 7:
if (this.isRule4TEST != (this.currentRule == 6)) continue;
break;
case 5:
case 8:
...
this.b$["JS.CIPChirality"].haveIsotopes = true;
...
function (a) {
if (this.nPriorities == (a == 0 ? 4 : 3)) return true;
var b = (a == -2147483648);
if (b) {
...
switch (j.atom == null ? 1 : l.atom == null ? -1 : d[i] < d[k] ? -1 : d[k] < d[i] ? 1 : (h = this.checkPriority (j, l, i, k)) != 0 ? h : b ? -2147483648 : this.sign (j.breakTie (l, a + 1))) {
case 1:
g = i;
case -1:
this.priorities[g]++;
...
if (this.parent == null) {
if (this.nSpiro > 0) {
var n = this.checkSpiro ();
if (n == 2) e = 2;
}if (this.b$["JS.CIPChirality"].currentRule == 9 && this.nPriorities == 4 && e == 2) {
...
Clazz.defineMethod (c$, "sortByRule", 
 function (a) {
if ((a == 7 || a == 6) && (a == 6) != this.b$["JS.CIPChirality"].isRule4TEST) return false;
...
case 6:
return (this.checkRule4Test (a));
case 7:
case 9:
return 0;
}
}, "JS.CIPChirality.CIPAtom");
Clazz.defineMethod (c$, "checkRule4Test", 
 function (a) {
var b = (this.auxChirality == '~');
if (this.rootSubstituent.atomIndex == a.rootSubstituent.atomIndex) {
if (b || a.auxChirality == '~') return (!b ? -1 : a.auxChirality != '~' ? 1 : 0);
return (this.auxChirality == a.auxChirality ? 0 : this.auxChirality == this.rootSubstituent.rule4Ref ? -1 : 1);
}return (b ? 0 : (this.auxChirality == a.auxChirality) == this.rootSubstituent.rule4checkIdentical ? 0 : this.auxChirality == this.rootSubstituent.rule4Ref ? -1 : 1);
}, "JS.CIPChirality.CIPAtom");
...
Clazz.defineMethod (c$, "checkRule2", 
 function (a) {
System.out.println (this.getMass () + " vs " + a.getMass () + " " + (a.getMass () == this.getMass () ? 0 : (this.reverseRule2 || a.reverseRule2) == (a.mass > this.mass) ? -1 : 1));
...
if (d.parent !== b) d.addReturnPath (b, a);
 else if (c == 9) d.rule4List = a.rule4List;
var e;
...
var c = (this.b$["JS.CIPChirality"].currentRule == 9);
...
e = this.getAuxEneWinnerChirality (this, this.alkeneChild, !this.isEvenEne, 9);
switch (e) {
case 17:
case 5:
e = 1;
